...
@Version: 2.0
@Autor: jce2090
@Date: 2020-05-23 14:21:41
@LastEditors: Seven
@LastEditTime: 2020-05-23 14:21:42
"""
import operator
import numpy as np
...
def evaluate(distances, labels, n_folds=10):
    """Evaluate
    """
    thresholds = np.arange(0, 30, 0.01)
    tpr, fpr, accuracy = calculate_roc(thresholds, distances, labels, n_folds)

    thresholds = np.arange(0, 30, 0.001)
    val, val_std, far = calculate_val(thresholds, distances, labels, 1e-3, n_folds)
